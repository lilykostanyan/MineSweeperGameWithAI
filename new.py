...
# Create labels for win/loss counters
win_label = Label(root, text=f"Wins: {win_count}")
loss_label = Label(root, text=f"Losses: {loss_count}")
win_label.grid(row=numOfRows + 1, column=0, columnspan=numOfCols // 2)
loss_label.grid(row=numOfRows + 1, column=numOfCols // 2, columnspan=numOfCols // 2)
