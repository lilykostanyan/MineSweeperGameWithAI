...
while True:
    ...
    if instructions:
        ...
        # Title
        title = largeFont.render("Play Minesweeper with Oppie", True, WHITE)
        ...
        buttonText = mediumFont.render("Play Game", True, YELLOW)
    ...
    bText = "Oppie" if not autoplay else "Stop"
    buttonText = mediumFont.render(bText, True, YELLOW)
    ...
    buttonText = mediumFont.render("AI Move", True, YELLOW)
    buttonRect = buttonText.get_rect()
    ...
    buttonText = mediumFont.render("Reset", True, YELLOW)
    buttonRect = buttonText.get_rect()
    ...
    buttonText = smallFont.render(bText, True, YELLOW)
    buttonRect = buttonText.get_rect()
